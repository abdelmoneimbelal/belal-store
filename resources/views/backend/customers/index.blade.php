                    ...
                    <tr>
                        <td>
                            @if ($customer->user_image != '')
                                <img class="img-thumbnail" src="{{ asset('assets/users/'. $customer->user_image) }}" style="width: 60px; height: 60px;" alt="{{ $customer->name }}">
                            @else
                                <img class="img-thumbnail" src="{{ asset('assets/users/avatar.svg') }}" style="width: 60px; height: 60px;" alt="{{ $customer->name }}">
                            @endif
                        </td>
                        <td>
