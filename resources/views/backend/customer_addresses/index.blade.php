                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="javascript:void(0)" onclick="deleteAddress({{ $address->id }})" class="btn btn-danger"><i class="fa fa-trash"></i></a>
        ...
        function deleteAddress(addressId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.getElementById('delete-address-' + addressId).submit();
                }
            });
        }
    </script>
