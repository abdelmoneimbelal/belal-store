                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="javascript:void(0)" onclick="deleteShippingCompany({{ $shipping_company->id }})" class="btn btn-danger"><i class="fa fa-trash"></i></a>
...
@section('script')
    <script>
        function deleteShippingCompany(shippingCompanyId) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    document.getElementById('delete-shipping-company-' + shippingCompanyId).submit();
                }
            });
        }
    </script>
