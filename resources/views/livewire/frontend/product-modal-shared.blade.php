                                ...
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div class="col-sm-5 pl-sm-0">
                                        <a wire:click="addToCart()"
                                            class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0 text-white">
                                            Add to cart
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-stretch">
                        <div class="col-12 p-5">
                            <div class="text-center">
                                ...
                                <p class="text-muted">The product you're looking for is not available or has been removed.</p>
