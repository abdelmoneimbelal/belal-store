  ...
  <section class="py-5">
    ...
    <div class="row mb-5">
      ...
      <div class="row m-sm-0">
        ...
        <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block"
          href="{{ asset('frontend/img/product-detail-1.jpg') }}" data-lightbox="product"
          title="Product item 1"><img class="img-fluid" src="{{ asset('frontend/img/product-detail-1.jpg') }}"
            alt="..."></a><a class="d-block" href="{{ asset('frontend/img/product-detail-2.jpg') }}"
          data-lightbox="product" title="Product item 2"><img class="img-fluid"
            src="{{ asset('frontend/img/product-detail-2.jpg') }}" alt="..."></a><a class="d-block"
          href="{{ asset('frontend/img/product-detail-3.jpg') }}" data-lightbox="product"
          title="Product item 3"><img class="img-fluid" src="{{ asset('frontend/img/product-detail-3.jpg') }}"
            alt="..."></a><a class="d-block" href="{{ asset('frontend/img/product-detail-4.jpg') }}"
      ...
      <p class="text-small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut ullamcorper leo, eget
        euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus. Vestibulum
        ultricies aliquam convallis.</p>
    ...
    <div class="tab-content mb-5" id="myTabContent">
      ...
      <div class="p-4 p-lg-5 bg-white">
        ...
        <p class="text-muted text-small mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
      ...
      <div class="p-4 p-lg-5 bg-white">
        ...
        <div class="col-lg-8">
          ...
          <div class="media-body ml-3">
            ...
            <p class="text-small mb-0 text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
    ...
    <div class="row">
      ...
      <div class="product text-center skel-loader">
        <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.html"><img class="img-fluid w-100"
